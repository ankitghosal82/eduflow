    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 to-black p-4">
      <Card className="w-full max-w-md bg-gray-800 text-gray-100 border-gray-700 shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-purple-400">{t("sign_in")}</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            {t("dont_have_account")}{" "}
            <Link href="/auth/register" className="font-medium text-purple-400 hover:underline">
              {t("sign_up")}
            </Link>
          </div>
        </CardContent>
