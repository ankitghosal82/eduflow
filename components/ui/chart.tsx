...
const ChartContainer = React.forwardRef<HTMLDivElement, ChartContainerProps & { config: ChartConfig }>(
  ({ className, config, ...props }, ref) => (
    <RechartsChartContainer ref={ref} className={cn("flex aspect-video w-full", className)} {...props}>
      <ChartContext.Provider value={{ config }}>{props.children}</ChartContext.Provider>
        ...
        <Pie
          ...
          activeShape={({
            ...
            <g>
              ...
              <Pie outerRadius={outerRadius + 10} {...props} />
            </g>
          )}
        >
          <Label
